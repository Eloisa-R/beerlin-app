...
urlpatterns = [
    ...
    url(r'^(?P<beer_name>[A-Za-z_0-9 äëïöüáéíóúàèìòùâêîôûßÇæœñ]+)/$', views.beer_detail, name='beer_detail'),
    ...
    url(r'^styles/(?P<style_name>[A-Za-z_0-9 äëïöüáéíóúàèìòùâêîôûßÇæœñ]+)/$',
